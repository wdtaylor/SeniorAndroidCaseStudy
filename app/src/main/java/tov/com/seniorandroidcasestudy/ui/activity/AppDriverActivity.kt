...
class AppDriverActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_launch_gp_broadcast_referrer.setOnClickListener {
            Intent().also { intent ->
                intent.action = GooglePlayReferrerReceiver.ACTION_INSTALL_REFERRER
                intent.putExtra(GooglePlayReferrerReceiver.KEY_REFERRER, "https%3a%2f%2fm.alltheapps.org%2fget%2fapp%3fuserId%3dB1C92850-8202-44AC-B514-1849569F37B6%26implementationid%3dcl-and-erp%26trafficSource%3derp%26userClass%3d20200101")
